...
const Footer = () => {
  ...
  return (
    <footer className="bg-black-50 dark:bg-black">
      ...
      <div className="border-black-200 dark:border-black-800 border-t py-10">
        <div className="mx-auto max-w-7xl px-4">
          <div className="flex flex-col items-center">
            {/* Logo */}
            <a href="/" className="mb-8 block">
              <picture>
                <source srcSet="/logo_black.avif" type="image/avif" />
                <source srcSet="/logo_black.webp" type="image/webp" />
                <img
                  src="/logo_black.png"
                  alt="Integral Clothing Logo"
            ...
            <div className="flex gap-4">
              {socialLinks.map((social, index) => (
                <a
                  ...
                  className="border-black-300 text-black-500 dark:border-black-700 dark:text-black-300 flex size-10 items-center justify-center border transition-all hover:border-black hover:bg-black hover:text-white active:border-black active:bg-black active:text-white sm:size-12 dark:hover:border-white dark:hover:bg-white dark:hover:text-black dark:active:border-white dark:active:bg-white dark:active:text-black"
                >
                  <social.icon size={24} />
                </a>
              ))}
